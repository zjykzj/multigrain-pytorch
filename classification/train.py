...
def load_data(traindir, valdir, args):
    ...
    # st = time.time()
    # train_transform, val_transform = build_transform(train_crop_size)
    #
    ...
    train_transform, val_transform = build_transform(args.train_crop_size)
    dataset = build_dataset(traindir, train_transform, split="train")
    dataset_test = build_dataset(valdir, val_transform, split="val")
